...
const AnimatedButton: React.FC<AnimatedButtonProps> = ({
	...
	const animatedContentStyle = useAnimatedStyle(() => {
		const baseColor = variant === 'primary' ? textHighlight : 'transparent';
	...
	return (
		...
		>
			<Animated.View style={[
				styles.btnBorder,
				variant === 'primary' && { borderColor: textHighlight },
				{ borderColor: variant === 'primary' ? textHighlight : textColor },
				animatedButtonStyle
			]}>
				<Animated.View style={[styles.btnContent, animatedContentStyle]}>
					<Text style={[
						styles.btnText,
						{ color: variant === 'primary' ? background : textColor },
					]}>
						{title}
					</Text>
